...
public class GeneratePayrolls implements Command<Void> {
	...
	public GeneratePayrolls(LocalDate currentDate) {
		this.date = currentDate;
	}

	@Override
	public Void execute() throws BusinessException {
		List<ContractBLDto> contratosEsteMes = ContractAssembler.toBLDtoList(cgtw.findByMonth(date.getMonth().toString()));
