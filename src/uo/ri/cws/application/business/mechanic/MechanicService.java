...
public interface MechanicService {
	...
	List<MechanicBLDto> findMechanicsInProfessionalGroups(String string) throws BusinessException;

	List<MechanicBLDto> findMechanicsWithContractInForceInContractType(String string) throws BusinessException;
