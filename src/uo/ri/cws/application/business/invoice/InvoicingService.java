...
public interface InvoicingService {
	 ...
	 */
	Optional<InvoiceBLDto> createInvoiceFor(List<String> workOrderIds)
	 ...
	 * 		child classes
	 */
	void settleInvoice(String dto, List<PaymentMeanBLDto> dtos)
			throws BusinessException;
